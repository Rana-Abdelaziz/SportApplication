...
//        collectionView.register(LatestResultsCollectionViewCell.nib(),)
//        collectionView.register(LatestResultsCollectionViewCell.nib(), cellForItemAt: LatestResultsCollectionViewCell.identifier)
